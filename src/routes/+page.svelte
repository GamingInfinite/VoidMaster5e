<script lang="ts">
  ...
  import FeatureList from "$lib/components/Features/FeatureList.svelte";
            ...
            <div class="flex flex-row justify-center">
              {#if statMode == StatModes.Dice}
                <div class="join">
                  ...
                  >
                    <svg class="w-8 h-8 fill-current" viewBox="110 250 350 400">
                      <path
  ...
  <div class="flex flex-col mr-4">
    ...
    {#if creationData.race || creationData.classes}
      ...
      {#if creationData.race}
        ...
        <FeatureList features={creationData.race.ASIFeatures}></FeatureList>
        {#if creationData.subRace != -1}
          <FeatureList
            features={creationData.race.subraces[creationData.subRace]
              .ASIFeatures}
          ></FeatureList>
          <FeatureList
            features={creationData.race.subraces[creationData.subRace]
          ...
          ></FeatureList>
        {/if}
        <FeatureList features={creationData.race.RacialAbilities}></FeatureList>
      {/if}
      <!-- #endregion -->
      <!-- #region Classes -->
